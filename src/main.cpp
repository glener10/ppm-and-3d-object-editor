/*Nome: Glener Pizzolato            Matricula: 1801570591
...
COMPILING:
g++ ppm.cpp -o ppm -lGL -lGLU -lglut


EXECUTE:
./ppm                               -Main code
./ppm S D 3D_1.obj 3D_2.obj         -To read n 3D Objects  (S = escala, D = Ditância focal)


EXEMPLO UTILIZADO P1
./ppm 750 100 cara.obj vicviper.obj elephant.obj


EXECUTE:
./main                               -Main code
./main -t 3D_1.obj 3D_2.obj          -To read n 3D Objects
./main -g 3D_1.obj 3D_2.obj          -To read n 3D Objects in a dynamic glut viewer

./main -s                            -To read n 3D Objects in a dynamic glut viewer using a script
...
*SCRIPT FORMAT:*
name1_3d.obj
scale1 centro_x centro_y
rotation_x rotation_y rotation_z
r g b

name2_3d.obj
scale2 centro_x centro_y
rotation_x rotation_y rotation_z
r g b
